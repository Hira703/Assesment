  ...
  return (
    <section className="bg-white py-16 px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col md:block md:min-h-[520px] mt-10 md:mt-0">
          {/* Yellow Base Card */}
          ...
          {/* Consultation Card */}
          <div className="bg-green-50 rounded-3xl shadow p-6 sm:p-8 text-center mt-6 md:absolute md:left-0 md:bottom-[10%] md:w-[250px] z-20">
          ...
          {/* Balance Card */}
          <div className="bg-white rounded-2xl shadow p-4 sm:p-5 w-full sm:w-52 mt-6 md:absolute md:right-[15%] md:top-[40%] md:rotate-[-6deg] z-30">
